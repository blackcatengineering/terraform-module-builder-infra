...
#   source      = "git@github.com:blackcatengineering/terraform-module-storage-classes"
...
module "builder-istio" {
  source = "git@github.com:blackcatengineering/terraform-module-istio"
  # version = "1.0.0"
...
module "builder-jenkins" {
  source = "git@github.com:blackcatengineering/terraform-module-jenkins"
  # version = "1.0.0"
...
module "builder-ip-masq" {
  source = "git@github.com:blackcatengineering/terraform-module-ip-masq-agent"
  # version = "1.0.0"
...
module "harness" {
  source = "git@github.com:blackcatengineering/terraform-module-harness"
  # version = "1.0.0"
...
module "cert-manager" {
  source = "git@github.com:blackcatengineering/terraform-module-cert-manager"
  # version = "1.0.0"
...
module "trust-manager" {
  source = "git@github.com:blackcatengineering/terraform-module-trust-manager"
  # version = "1.0.0"
...
module "jaeger" {
  source = "git@github.com:blackcatengineering/terraform-module-jaeger"
  # version = "1.0.0"
